...
const UserProfileCard = () => {
  ...
  // Zustand store updates on initialization, before the component is hydrated
  // This causes a hydration error
  // To be fixed with the skipHydration flag
      ...
      {user && isHydrated ? (
        <>
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-(--cool-gray-60)">{user.email}</p>
            <Link
              href={"/profile/edit"}
