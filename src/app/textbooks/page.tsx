...
export const metadata: Metadata = {
  title: "Katalog udžbenika",
  description: "Pretraga i kupovina polovnih školskih udžbenika u Beogradu. Filtrirajte po razredu, predmetu, autoru i ceni.",
};
    ...
    <section className="flex flex-col items-center pt-10 sm:pt-20 pb-5 gap-10">
      <div className="flex flex-col items-center">
        <h3 className="text-lg font-bold leading-tight text-blue-900 text-center w-2/3 uppercase">
          Polovni školski udžbenici
        </h3>
        <h1 className="text-3xl sm:text-5xl font-bold">Katalog udžbenika</h1>
      </div>
